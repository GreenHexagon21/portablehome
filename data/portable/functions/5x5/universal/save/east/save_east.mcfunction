setblock ~ ~ ~-3 structure_block[mode=save]{name:"portable:base",posX:-5,posY:-1,posZ:1,sizeX:5,sizeY:5,sizeZ:5,rotation:"NONE",mirror:"NONE",mode:"SAVE",ignoreEntities:1b} replace
