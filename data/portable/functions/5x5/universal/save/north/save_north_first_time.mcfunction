setblock ~-3 ~ ~ structure_block[mode=save]{name:"portable:base",posX:1,posY:-1,posZ:1,sizeX:5,sizeY:7,sizeZ:5,rotation:"NONE",mirror:"NONE",mode:"SAVE",ignoreEntities:1b} replace
...
setblock ~-2 ~ ~1 structure_block{name:"portable:5x5_empty_north",posX:0,posY:-1,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~-2 ~1 ~1 redstone_block replace
fill ~-2 ~ ~1 ~-2 ~1 ~1 air replace

kill @e[type=item,distance=0..10,nbt={Item:{}}]

function portable:5x5/universal/save/north/effects
