...
setblock ~1 ~ ~6 structure_block{name:"portable:restore",posX:0,posY:-1,posZ:0,rotation:"COUNTERCLOCKWISE_90",mirror:"NONE",mode:"LOAD"} replace
setblock ~1 ~1 ~6 redstone_block replace
fill ~1 ~ ~6 ~1 ~1 ~6 air replace

kill @e[type=item,distance=0..20,nbt={Item:{}}]

function portable:13x13/universal/save/west/effects
