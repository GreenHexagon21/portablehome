setblock ~7 ~ ~ structure_block[mode=save]{name:"portable:restore",posX:-13,posY:-1,posZ:-13,sizeX:13,sizeY:13,sizeZ:13,rotation:"NONE",mirror:"NONE",mode:"SAVE",ignoreEntities:1b} replace
...
setblock 100000 -59 100016 structure_block{name:"portable:restore",posX:13,posY:0,posZ:13,rotation:"CLOCKWISE_180",mirror:"NONE",mode:"LOAD"} replace
...
setblock ~6 ~ ~-1 structure_block{name:"portable:base",posX:0,posY:-1,posZ:0,rotation:"CLOCKWISE_180",mirror:"NONE",mode:"LOAD"} replace
setblock ~6 ~1 ~-1 redstone_block replace

function portable:13x13/universal/save/south/effects
