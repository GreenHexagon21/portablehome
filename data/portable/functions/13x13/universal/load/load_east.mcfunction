setblock ~ ~ ~-7 structure_block[mode=save]{name:"portable:restore",posX:-13,posY:-1,posZ:1,sizeX:13,sizeY:13,sizeZ:13,rotation:"NONE",mirror:"NONE",mode:"SAVE",ignoreEntities:1b} replace
...
setblock ~-1 ~ ~-6 structure_block{name:"portable:base",posX:0,posY:-1,posZ:0,rotation:"CLOCKWISE_90",mirror:"NONE",mode:"LOAD"} replace
setblock ~-1 ~1 ~-6 redstone_block replace

function portable:13x13/universal/save/east/effects

function portable:13x13/universal/util/after_load