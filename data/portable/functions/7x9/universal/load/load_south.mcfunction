setblock ~4 ~ ~ structure_block[mode=save]{name:"portable:restore",posX:-7,posY:-1,posZ:-9,sizeX:7,sizeY:7,sizeZ:9,rotation:"NONE",mirror:"NONE",mode:"SAVE",ignoreEntities:1b} replace
...
function portable:7x9/universal/save/south/effects
