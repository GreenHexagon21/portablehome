setblock ~-4 ~ ~ structure_block[mode=save]{name:"portable:base",posX:1,posY:-1,posZ:1,sizeX:9,sizeY:10,sizeZ:10,rotation:"NONE",mirror:"NONE",mode:"SAVE",ignoreEntities:1b} replace
...
setblock ~-3 ~ ~1 structure_block{name:"portable:empty_north",posX:0,posY:-1,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~-3 ~1 ~1 redstone_block replace
fill ~-3 ~ ~1 ~-3 ~1 ~1 air replace
function portable:7x9/north/util/after_save_first