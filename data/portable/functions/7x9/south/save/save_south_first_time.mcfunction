...
setblock ~3 ~ ~-1 structure_block{name:"portable:empty_north",posX:0,posY:-1,posZ:0,rotation:"CLOCKWISE_180",mirror:"NONE",mode:"LOAD"} replace
setblock ~3 ~1 ~-1 redstone_block replace
fill ~3 ~ ~-1 ~3 ~1 ~-1 air replace

function portable:7x9/south/util/after_save_first