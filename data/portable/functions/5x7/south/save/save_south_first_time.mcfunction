...
setblock ~2 ~ ~-1 structure_block{name:"portable:5x7_empty_north",posX:0,posY:-1,posZ:0,rotation:"CLOCKWISE_180",mirror:"NONE",mode:"LOAD"} replace
setblock ~2 ~1 ~-1 redstone_block replace
fill ~2 ~ ~-1 ~2 ~1 ~-1 air replace

function portable:5x7/south/util/after_save_first