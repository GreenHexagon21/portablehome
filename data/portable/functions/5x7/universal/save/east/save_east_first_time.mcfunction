...
setblock ~-1 ~ ~-2 structure_block{name:"portable:5x7_empty_east",posX:-6,posY:-1,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~-1 ~1 ~-2 redstone_block replace
fill ~-1 ~-1 ~-2 ~-1 ~1 ~-2 air replace

kill @e[type=item,distance=0..10,nbt={Item:{}}]

function portable:5x7/universal/save/east/effects
