setblock ~ ~ ~5 structure_block[mode=save]{name:"portable:base",posX:1,posY:-1,posZ:-9,sizeX:11,sizeY:9,sizeZ:9,rotation:"NONE",mirror:"NONE",mode:"SAVE",ignoreEntities:1b} replace
...
setblock ~1 ~ ~4 structure_block{name:"portable:9x11_empty_east",posX:10,posY:-1,posZ:0,rotation:"CLOCKWISE_180",mirror:"NONE",mode:"LOAD"} replace
