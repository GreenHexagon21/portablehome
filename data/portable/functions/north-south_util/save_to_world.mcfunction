...
setblock -47 57 16 structure_block[mode=save]{name:"portable:restore",posX:1,posY:0,posZ:1,sizeX:9,sizeY:10,sizeZ:10,rotation:"NONE",mirror:"NONE",mode:"SAVE",ignoreEntities:1b} replace
