...
setblock ~-5 ~ ~1 structure_block{name:"portable:restore",posX:0,posY:-1,posZ:0,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~-5 ~1 ~1 redstone_block replace
fill ~-5 ~ ~1 ~-5 ~1 ~1 air replace

kill @e[type=item,distance=0..18,nbt={Item:{}}]

function portable:11x13/universal/save/north/effects
